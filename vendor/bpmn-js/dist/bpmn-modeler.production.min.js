/*! bpmn-js - bpmn-modeler v3.0.4 | Copyright (c) 2014-present, camunda Services GmbH | bpmn.io/license */
...
/**
	 ...
	 */function Co(e){return e.join(";")}var To,Ao='<div class="bjs-powered-by-lightbox" style="'+Co(["z-index: 1001","position: fixed","top: 0","left: 0","right: 0","bottom: 0"])+'"><div class="backdrop" style="'+Co(["width: 100%","height: 100%","background: rgba(0,0,0,0.2)"])+'"></div><div class="notice" style="'+Co(["position: absolute","left: 50%","top: 40%","margin: 0 -130px","width: 260px","padding: 10px","background: white","border: solid 1px #AAA","border-radius: 3px","font-family: Helvetica, Arial, sans-serif","font-size: 14px","line-height: 1.2em"])+'"><a href="http://bpmn.io" target="_blank" style="float: left; margin-right: 10px">'+So+'</a>Web-based tooling for BPMN, DMN and CMMN diagrams powered by <a href="http://bpmn.io" target="_blank">bpmn.io</a>.</div></div>';var Ro={width:"100%",height:"100%",position:"relative"};function Po(e){return e+(l(e)?"px":"")}function ko(e){
/**
